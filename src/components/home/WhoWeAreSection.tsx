  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1366px] px-4 md:px-8 lg:px-8 xl:px-10 xl:py-12">
        <div className="flex flex-col items-stretch gap-8 max-lg:gap-6 lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-6 lg:gap-y-6 xl:flex xl:flex-row xl:gap-x-0 xl:gap-y-0">
          <div className="max-lg:order-1 lg:col-start-1 lg:row-start-1 xl:w-auto">
          ...
          <div className="max-lg:order-3 lg:col-start-1 lg:row-start-2 lg:mt-6 xl:mt-8">
          ...
          <div className="flex flex-col items-center pt-0 text-center max-lg:order-4 max-lg:w-full lg:col-start-2 lg:row-start-1 lg:items-start lg:text-left xl:pl-16">
          ...
          <div className="flex flex-col items-stretch gap-6 max-lg:order-2 max-lg:items-center md:gap-7 lg:col-start-2 lg:row-start-2 lg:flex-row lg:items-center lg:gap-5 xl:mt-auto xl:gap-8 xl:pt-14">
            <div className="relative aspect-[1667/1321] w-full min-w-0 flex-1 overflow-hidden rounded-[20px] bg-[#f5f0ea] max-lg:mx-auto max-lg:max-w-[560px] xl:aspect-auto xl:h-[312px] xl:max-w-none">
              <Image
