      ...
      <div className="mx-auto max-w-[1366px] px-4 md:px-8 lg:px-8 xl:px-10">
        <div className="flex flex-col items-stretch gap-8 max-lg:gap-8 lg:grid lg:grid-cols-2 lg:items-start lg:gap-x-6 xl:flex xl:flex-row xl:gap-x-0">
          <div className="w-full max-lg:order-1 xl:w-auto">
            ...
            <div className="mt-6 grid w-full grid-cols-2 gap-3 max-lg:w-full md:mt-7 md:gap-4 lg:mt-6 xl:mt-8 xl:flex xl:w-[670px] xl:flex-wrap xl:gap-4">
              {stats.map((stat) => (
          ...
          <div className="flex min-w-0 flex-col self-stretch max-lg:order-2 max-lg:w-full xl:flex-1">
            <div className="flex flex-col items-center pt-0 text-center max-lg:pl-0 lg:items-start lg:pl-0 lg:text-left xl:pl-16">
